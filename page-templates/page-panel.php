        ...
        <main class="dashboard-main">
            <header class="dashboard-header reveal-fade">
                ...
                <div class="header-actions">
                    <a href="<?php echo site_url(); ?>" target="_blank" class="button button-outline" style="padding: 8px 16px; font-size: 0.9rem;">Ver mi tienda</a>
                </div>
            </header>
            ...
            <div class="dashboard-content">
                ...
                <!-- Content Area: Mis Productos -->
                <div class="dashboard-panel glass-card reveal-up delay-200" style="margin-top: 40px;" id="seccion-productos">
